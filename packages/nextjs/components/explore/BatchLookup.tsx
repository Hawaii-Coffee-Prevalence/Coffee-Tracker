...
export const BatchLookup = ({ onSearch }: Props) => {
  return (
    <div className="overflow-x-auto mb-6">
      <div className="grid grid-cols-3 min-w-[480px] gap-px bg-base-300 border border-base-300 rounded-xl overflow-hidden">
        ...
        <div className="bg-base-100 p-7 flex flex-col gap-3">
          ...
          <div className="flex-1 flex items-center justify-center border-2 border-base-300 rounded-xl text-secondary/40 min-h-[64px] hover:bg-base-200" />
        </div>
      </div>
    </div>
  );
