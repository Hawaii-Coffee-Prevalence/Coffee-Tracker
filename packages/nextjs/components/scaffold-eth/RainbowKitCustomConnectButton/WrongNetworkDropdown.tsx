...
export const WrongNetworkDropdown = () => {
  ...
  return (
    <details ref={dropdownRef} className="dropdown dropdown-end leading-3 group">
      <summary className="btn btn-error text-cream border-none btn-sm p-2 shadow-md dropdown-toggle gap-2 !h-auto font-sans text-xs font-medium tracking-[0.1em] uppercase">
